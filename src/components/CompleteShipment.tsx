...
const CompleteShipment = ({
  ...
  return completeModal ?(
    <div className='fixed inset-0 z-10 overflow-y-auto'>
      <div className='fixed inset-0 w-full bg-black opacity' onClick={()=>setCompleteModal(false)}>
      </div>
          ...
          <div className='max-w-sm mx-auto py-3 space-y-3 text-center'>
            ...
            <form onSubmit={(e: any)=>e.preventDefault()}>
              <div className='relative mt-3'>
                ...
                className='w-full pl-5 pr-3 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg' onChange={(e: any)=>setCompleteShip({...completeShip, receiver: e.target.value})}/>
              </div>
              ...
              <div className='relative mt-3'>
                ...
                onChange={(e: any)=>setCompleteShip({
